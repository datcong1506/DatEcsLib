...
namespace DatECSLib
{
    internal class AspectScriptsTemplate
    {
        private static readonly string tailName = "_Aspect";
        private static readonly string _path = "Assets/DatECSLib/Scripts/Editor/Template/Aspect/AspectTXT.txt";

        [MenuItem("Assets/Create/ECS/Aspect", false, 0)]
