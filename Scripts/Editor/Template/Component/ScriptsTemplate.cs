...
namespace DatECSLib
{
    internal class ScriptsTemplate
    {
        private static readonly string tailName = "_Component";
        private static readonly string _path = "Assets/DatECSLib/Scripts/Editor/Template/Component/ComponentTXT.txt";
